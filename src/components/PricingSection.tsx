...
export const PricingSection: React.FC = () => {
    return (
        <div className="flex flex-col items-center md:items-stretch align-center p-8 lg:p-16 lg:gap-12 gap-8 md:flex-row justify-center w-full">
...
const PackageCard: React.FC<{
    ...
    return (
        <div ref={ref_main} className={`flex flex-col flex flex-1 items-stretch align-center w-11/12 md:w-auto transition-opacity ease-in duration-1800 ${isSectionVisible.wasViewed ? "opacity-100" : "opacity-0"}`}>
