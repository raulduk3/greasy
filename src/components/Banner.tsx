...
const StatsBanner = async () => {
    ...
    return (
        <>
            <h1 id="why-use-greasy" className="text-[2.6em] w-8/12 px-6 font-semibold text-white mt-6">Why Use GREasy?</h1>
            <div className="text-black px-6 py-4 items-center flex flex-col gap-6">
                <div className="flex flex-col items-stretch w-full lg:w-8/12 gap-6">
                    <div className="flex flex-col md:flex-row items-stretch justify-center gap-6">
                        <div className=" p-6 border bg-white flex flex-col rounded shadow-lg">
                            <h4 className="text-2xl text-black  font-semibold mb-4">GREasy is different.</h4>
