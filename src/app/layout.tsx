		...
		<html lang="en" className={inter.className}>
			<body className={cn("flex flex-col min-h-screen max-w-full overflow-x-hidden font-sans bg-slate-700 text-white", inter.className)}>
				<header className="flex flex-col items-center text-white">
					...
					<h2 className="text-m text-center mx-4 my-2">Personalized GRE flashcards directly to your inbox 🎉</h2>
				...
				<main className="flex flex-col flex-1 items-center justify-center w-full gap-3">
					{children}
					<Analytics />
