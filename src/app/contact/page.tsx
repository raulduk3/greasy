...
const ContactPage: React.FC = () => {
    return (
        <div className="flex flex-col items-center p-8 font-sans text-white gap-4">
            ...
            <p className="max-w-xl text-left">
                <strong>Email:</strong> You can email us at <a href={`mailto:rawalvarez731@gmail.com?subject=GREasy Support Request ${new Date().toDateString()}`} className="text-green-500 no-underline">rawalvarez731@gmail.com</a>. <br /> <br /> I strive to respond to all inquiries within 24 hours.
